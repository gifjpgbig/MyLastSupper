...
public class FavoritesController {
	...
	public String createOrDeleteFavorites
	(@PathVariable Integer cusID,@PathVariable Integer shopID) {
	...
	public String findFavoritesShopByCusID(@PathVariable Integer cid) {
		...
		for(FavoritesBean FavoriteShop:FavoriteShopIDList) {
			JSONObject item = new JSONObject()
					.put("id",FavoriteShop.getShop().getId());
			array.put(item);
		}
	...
	public String findAllFavoritesShop(@PathVariable Integer cid) {
		 ...
		 for(FavoritesBean favorite:favorites) {
			 JSONObject item = new JSONObject()
					 .put("id", favorite.getShop().getId())
					 .put("name", favorite.getShop().getName())
					 .put("phone", favorite.getShop().getPhone())
					 .put("address", favorite.getShop().getAddress())
					 .put("openStatus", favorite.getShop().getOpenStatus())
					 .put("email",favorite.getShop().getEmail());
