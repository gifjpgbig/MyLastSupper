  ...
  <div class="container">
    <div class="feedback">
      <div class="rating">
        ...
        <!-- <p>{{ selectedRating }}</p> -->
        <!-- <input v-for="rating in ratings" :key="rating" type="radio" name="rating" :id="'rating-' + rating" :value="rating" v-model="selectedRating" />
      <label v-for="rating in ratings" :key="rating" :for="'rating-' + rating"></label> -->
...
// const selectedRating = ref('2'); // Set the initial value
